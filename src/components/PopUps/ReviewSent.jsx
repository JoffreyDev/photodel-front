...
const ReviewSent = ({ reviewSentModalActive, setReviewSentModalActive }) => {
  return (
    <ModalWindow
      moduleActive={reviewSentModalActive}
      setModuleActive={setReviewSentModalActive}
    >
      <div className="reg_auth_header">
        <h1 className="reg_auth_header_title">Спасибо!</h1>
        <svg
          style={{
            padding: "5px",
          ...
          onClick={() => setReviewSentModalActive(false)}
          width="14"
          height="14"
          viewBox="0 0 14 14"
          fill="none"
      ...
      <div className="reg_auth_content_fields">
        ...
        <GreenButton
          callback={() => {
            setReviewSentModalActive(false);
          }}
          text="Ок"
          width={"100%"}
          height={"38px"}
