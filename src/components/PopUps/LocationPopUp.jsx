  ...
  return (
    <div className='main_page_header_loc_select'>
      <div
        ...
        {styled === 'themed' && (
          <img src={GreenLocation} alt='location' className='main_page_header_loc_vector' />
        )}
        <p style={styled === 'themed' ? { color: 'black' } : {}} className='main_page_header_loc_p'>
        ...
        <div className='main_page_header_loc_select_popup'>
          <div className='main_page_header_loc_select_popup_content'>
            ...
            <div className='main_page_header_loc_select_popup_content_cities'>
              {fetchedCities &&
                fetchedCities
                  .filter((city) => city.city_name.toLowerCase().includes(cityName.toLowerCase()))
                  .map((city) => {
