...
const EmailConfirmedModal = ({
  emailConfirmedModalActive,
  setEmailConfirmedModalActive,
  setLogModuleActive,
}) => {
  return (
    <ModalWindow
      moduleActive={emailConfirmedModalActive}
      setModuleActive={setEmailConfirmedModalActive}
    >
      ...
      <div className="reg_auth_content_fields">
        <p
          ...
          onClick={() => setEmailConfirmedModalActive()}
