...
const Header = ({ styled, border }) => {
  ...
  const { isLoggedIn, userData, notifications } = useSelector(
    ({ userData }) => userData
  );
              ...
              {isLoggedIn && (
                <div className="main_page_header_top_row_user_group">
                  ...
                  <img
                    ...
                    onClick={() => setNotifyPopUpActive(true)}
                  />
                  <img
                  ...
                  {notifyPopUpActive && (
                    <NotifyPopUp
                      ...
                      setActive={setNotifyPopUpActive}
                    />
                  )}
                  {notifications[0]?.new_notifications > 0 && (
                    <div className="notifications_counter_wrapper">
                      <p>{notifications[0].new_notifications}</p>
                    </div>
                  )}
                </div>
              )}
          ...
          <div className="main_page_header_bottom_row">
            ...
            {isLoggedIn && window.screen.width <= 576 && (
              <div className="main_page_header_top_row_user_group">
                ...
                {userData.new_notifications > 0 && (
                  <div className="notifications_counter_wrapper">
                    <p>{userData.new_notifications}</p>
                  </div>
                )}
              </div>
            )}
