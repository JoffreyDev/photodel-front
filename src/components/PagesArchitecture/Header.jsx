...
import { toggleRegModule, toggleLogModule } from '../../redux/actions/siteEntities';
...
const Header = ({ styled, border }) => {
  ...
  const { logModuleActive, regModuleActive } = useSelector(({ siteEntities }) => siteEntities);
  ...
  const [loggedUserPopupActive, setLoggedUserPopupActive] = React.useState(false);
  ...
  return (
    <header className='main_page_header'>
        ...
        <Menu isOpen={menuOpened} onClose={() => setMenuOpened(false)}>
          ...
          <div className='main_page_header_theme_select mobile'>
            <ThemeContext.Consumer>
              {({ theme, setTheme }) => (
                <p className='main_page_header_theme_p__left disabled'>Темная</p>
              )}
            </ThemeContext.Consumer>
            ...
            <ThemeContext.Consumer>
              {({ theme, setTheme }) => (
                <p className='main_page_header_theme_p__left disabled'>Светлая</p>
              )}
            </ThemeContext.Consumer>
          </div>
        </Menu>
      ...
      <div className='main_page_header_container'>
        <div className='main_page_header_rows'>
                ...
                <div className='main_page_header_lang_select'>
                  ...
                  {styled === 'main' && (
                    <svg
                      ...
                      fill='none'
                      xmlns='http://www.w3.org/2000/svg'>
                      <path d='M11 1.5L6 6.5L1 1.5' stroke='white' strokeWidth='1.5' />
                    </svg>
                  )}
              ...
              {isLoggedIn && (
                <div className='main_page_header_top_row_user_group'>
                  ...
                  {loggedUserPopupActive && (
                    <LoggedUserPopup setLoggedUserPopupActive={setLoggedUserPopupActive} />
                  )}
                </div>
              )}
            </div>
          ...
          <hr
            ...
            className='main_page_header_top_row_hr'></hr>
          ...
          <div className='main_page_header_bottom_row'>
            ...
            <div className='main_page_header_bottom_row_left'>
              ...
              {styled === 'themed' && (
                <Link to='/'>
                  <img alt='logo' className='main_page_header_bottom_row_left__logo' src={Logo} />
                </Link>
              )}
              <Link to='/'>
                <p
          ...
          <hr
            ...
            className='main_page_header_bottom_row_hr'></hr>
        </div>
      </div>
      <RegModule
      ...
      <EmailMessageSent
        ...
        setEmailSentModalActive={setEmailSentModalActive}
      />
      <ResetPass resetPassActive={resetPassActive} setResetPassActive={setResetPassActive} />
    </header>
  );
};
