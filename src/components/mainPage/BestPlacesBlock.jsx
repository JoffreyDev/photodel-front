        ...
        <div className='main_page_third_section_content_upper_row'>
          ...
          {false && (
            <ul className='main_page_third_section_content_upper_row_rigth'>
              <li className='main_page_third_section_content_upper_row_rigth_li active'>Все</li>
              <li className='main_page_third_section_content_upper_row_rigth_li'> Город</li>
              <li className='main_page_third_section_content_upper_row_rigth_li'>Пляжи</li>
              <li className='main_page_third_section_content_upper_row_rigth_li'>
                Достопримечательности
              </li>
              <li className='main_page_third_section_content_upper_row_rigth_li'>Музеи</li>
              <li className='main_page_third_section_content_upper_row_rigth_li'>Прочие</li>
            </ul>
          )}
        </div>
            ...
            <Carousel
              ...
              {!places &&
                Array(8)
                  .fill(' ')
                  .map((place, idx) => (
                    <BestPlaceCard key={idx} width={window.screen.width <= 576 ? '120px' : ''} />
                  ))}
            </Carousel>
          )}
        </div>
