...
import { GalleryPhotoPreview } from '..';
import Requests from '../../http/axios-requests';
import Carousel from 'react-elastic-carousel';
import { useNavigate } from 'react-router-dom';

const PopularPhotosBlock = () => {
  const [photos, setPhotos] = React.useState();

  const navigate = useNavigate();

  React.useEffect(() => {
    Requests.getPopularPhotos().then((res) => setPhotos(res.data));
  }, []);

  return (
    <section className='main_page_popular_photos_section_wrapper'>
      <div className='main_page_popular_photos_section_content'>
        ...
        <div className='main_page_popular_photos_section_content_slider_wrapper'>
          {photos && (
            <Carousel
              itemsToShow={window.screen.width <= 576 ? window.screen.width / 270 : 4}
              pagination={false}
        ...
        <div className='main_page_popular_photos_section_content_lower_table'>
          <svg
            className='main_page_popular_photos_section_content_lower_table_image'
            width='24'
            height='24'
            viewBox='0 0 24 24'
            fill='none'
          ...
          <p
            ...
            className='main_page_popular_photos_section_content_lower_table_p'>
...
export default PopularPhotosBlock;
