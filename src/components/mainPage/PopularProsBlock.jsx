...
import { PopularProCard } from '..';
import Requests from '../../http/axios-requests';
import Carousel from 'react-elastic-carousel';
import { useNavigate } from 'react-router-dom';

const PopularProsBlock = () => {
  const [profiles, setPorfiles] = React.useState();
  ...
  return (
    <section className='main_page_second_section_wrapper'>
      <div className='main_page_second_section_content'>
        <div className='main_page_second_section_content_upper_row'>
          <div className='main_page_second_section_content_upper_row_left'>
            <h2 className='main_page_second_section_content_upper_row_left_h2'>Популярные Профи</h2>
            {/* <div className="main_page_second_section_content_upper_row_left_checkbox_wrapper">
              <input
                type="checkbox"
                className="main_page_second_section_content_upper_row_left_checkbox"
                id="profies_near_check"
              />
              <label
                htmlFor="profies_near_check"
                className="main_page_second_section_content_upper_row_left_label"
              >
                Рядом с Вами
              </label>
            </div> */}
          ...
          {false && (
            <ul className='main_page_second_section_content_upper_row_rigth'>
              <li className='main_page_second_section_content_upper_row_rigth_li active'>Все</li>
              <li className='main_page_second_section_content_upper_row_rigth_li'>фотографы</li>
              <li className='main_page_second_section_content_upper_row_rigth_li'>Модели</li>
              <li className='main_page_second_section_content_upper_row_rigth_li'>Студии</li>
              <li className='main_page_second_section_content_upper_row_rigth_li'>Визажисты</li>
              <li className='main_page_second_section_content_upper_row_rigth_li'>Прочие</li>
            </ul>
          )}
        </div>
        <div className='main_page_second_section_content_slider_wrapper'>
          {profiles && (
            <Carousel
              itemsToShow={window.screen.width <= 576 ? window.screen.width / 165 : 6}
              pagination={false}
              showArrows={window.screen.width <= 576 ? false : true}>
              {profiles &&
                profiles.map((profile, idx) => <PopularProCard profile={profile} key={idx} />)}
            </Carousel>
          )}
          {!profiles && (
            <Carousel
        ...
        <div className='main_page_second_section_content_lower_table'>
          <svg
            className='main_page_second_section_content_lower_table_image'
            width='24'
            height='24'
            viewBox='0 0 24 24'
            fill='none'
          ...
          <p
            ...
            className='main_page_second_section_content_lower_table_p'>
...
export default PopularProsBlock;
