      ...
      <div className='profile_basis'>
        <div className='profile_basis_content'>
          ...
          <div className='profile_basis_module_component'>
            {component === 'profile' && (
              <PublicProfile setProfileId={setProfileId} component={component} />
            )}

            {component === 'sessions' && (
              <PublicSessions setProfileId={setProfileId} component={component} />
            )}
            {component === 'trainings' && (
              <PublicTrainings setProfileId={setProfileId} component={component} />
            )}
            {component === 'photos' && (
            ...
            {component === 'training' && <PublicTrainingView setProfileId={setProfileId} />}
            {component === 'session' && <PublicSessionView setProfileId={setProfileId} />}
            {component === 'places' && <PublicPlaces setProfileId={setProfileId} />}
            {component === 'favorites' && <PublicFavorites setProfileId={setProfileId} />}
            {component === 'requests' && <PublicRequests setProfileId={setProfileId} />}
          </div>
        </div>
      </div>
      <Footer />
